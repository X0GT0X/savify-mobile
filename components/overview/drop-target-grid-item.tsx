...
const DropTargetGridItemComponent: React.FC<DropTargetGridItemProps> = ({
  item,
  targetType,
  children,
  scrollVersion,
...
export const DropTargetGridItem = React.memo(DropTargetGridItemComponent);
DropTargetGridItem.displayName = 'DropTargetGridItem';
